export const CROPS = [
  ...
  { name: 'Zucchini', minutes: 30, seed: 0.3, sell: 0.48, xp: 0.15 },
  { name: 'Carrot', minutes: 60, seed: 0.5, sell: 0.8, xp: 0.2 },
  { name: 'Yam', minutes: 60, seed: 0.7, sell: 1.1, xp: 0.25 },
  { name: 'Cabbage', minutes: 120, seed: 1, sell: 1.5, xp: 0.4 },
  { name: 'Broccoli', minutes: 120, seed: 1.5, sell: 2.2, xp: 0.5 },
  { name: 'Soybean', minutes: 180, seed: 1.25, sell: 1.9, xp: 0.6 },
  { name: 'Beetroot', minutes: 240, seed: 2, sell: 2.8, xp: 0.8 },
  { name: 'Pepper', minutes: 300, seed: 2.5, sell: 3.6, xp: 1 },
  ...
  { name: 'Corn', minutes: 1440, seed: 7, sell: 9, xp: 3 },
  { name: 'Radish', minutes: 1440, seed: 7, sell: 9.5, xp: 3.2 },
  { name: 'Wheat', minutes: 1440, seed: 5, sell: 7, xp: 3 },
  { name: 'Kale', minutes: 2160, seed: 10, sell: 13, xp: 4 },
  { name: 'Barley', minutes: 2880, seed: 12, sell: 16, xp: 5 },
] as const
