...
export default async function Page({ searchParams }: { searchParams?: Promise<Record<string,string>> }) {
  ...
  return <main className="wrap">
    ...
    <section className="card" style={{marginBottom:14}}><h2>Quick start</h2><ol><li><b>Tambah timer panen</b>: pilih crop, isi jumlah plot, klik Add Timer.</li><li><b>Reminder Telegram</b>: otomatis aktif. Tidak perlu setting manual.</li><li><b>Test Telegram</b>: opsional, cuma untuk cek bot masuk.</li><li><b>Inventory</b>: catat bahan/crop yang kamu punya.</li><li><b>Crafting planner</b>: pilih target craft, helper akan hitung bahan kurang.</li></ol><p className="muted">Catatan: helper ini tidak auto-click game. Ini planner + reminder aman.</p></section>
    <div className="grid">
